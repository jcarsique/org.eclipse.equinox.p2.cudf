 ...
 * in the query can be evaluated by calling isMatch on it. If
 * {@link #isMatch(Object)} returns true,
 * then the element WILL be included in the query result. If
 * {@link #isMatch(Object)} returns false, then
 ...
 * match computation, to allow {@link IQueryable} implementations to optimize
 * their execution of the query.
 */
public abstract class MatchQuery implements Query {
    ...
    /**
     * Performs this query on the given iterator, passing all objects in the
     * iterator
    ...
    /**
     * Execute any pre-processing that must be done before this query is
     * performed against
     * a particular iterator. This method may be used by subclasses to do any
     * calculations,
     * caching, or other preparation for the query.
     * <p>
     * This method is internal to the framework. Subclasses may override this
     * method, but should not call this method.
     * 
     * @noreference This method is not intended to be referenced by clients.
     */
    ...
    /**
     * Execute any post-processing that must be done after this query has been
     * performed against
     * a particular iterator. This method may be used by subclasses to clear
     * caches or any other
     * cleanup that should occur after a query.
     * <p>
     * This method will be called even if the query does not complete
     * successfully.
     * <p>
     * This method is internal to the framework. Subclasses may override this
     * method, but should not call this method.
